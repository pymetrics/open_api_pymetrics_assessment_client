...
from openapi_client import MercuryAssessmentOrder
from openapi_client.api import default_api
from openapi_client.configuration import Configuration
from openapi_client.examples.constants import ENV_NAME_CLIENT_ID, \
    ENV_NAME_CLIENT_SECRET, BASE_URL, ENV_NAME_X_API_KEY, ORDER_UUID
...
def main():
    ...
    with openapi_client.ApiClient(configuration) as api_client:
        ...
        try:
            ...
            get_order_response: MercuryAssessmentOrder = api_instance.mercury_retrieve_order(
                authorization=auth,
                x_api_key=x_api_key,
                uuid=ORDER_UUID
            )

            print(f"Successfully retrieved order: {get_order_response}")
